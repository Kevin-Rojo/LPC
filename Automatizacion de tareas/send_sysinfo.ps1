...
$Username = "ksrojo31@gmail.com"; # Aqui va tu cuenta de gmail

$Password = "hcamjsuzifplevqs";      # Aqui va tu password de aplicación
...
function Send-ToEmail([string]$email, [string]$attachmentpath){
    ...
    $message.From = "ksrojo31@gmail.com"; # Aqui va tu cuenta de gmail.
...
Send-ToEmail  -email "kevin.rojoor@gmail.com" -attachmentpath $path; # En email pones el destinatario
